report 55008 "Sale Invoice IN GST Test"
{
    DefaultLayout = RDLC;
                    ...
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        begin
                            ...
                            if No = 1 then begin
                                ...
                                GetTCSAmt("Sales Invoice Header", myecref);
                            end;
    ...
    local procedure GetTCSAmt(SalesInvoiceHeader: Record "Sales Invoice Header"; SalesInvoiceLine: FieldRef)
    var
        TCSEntry: Record "TCS Entry";
        SalesInvoiceHeader1: Record "Sales Invoice Line";
    begin
        Clear(TCSAmt);
        TCSEntry.Reset();
        TCSEntry.SetRange("Document No.", SalesInvoiceHeader1."Document No.");
