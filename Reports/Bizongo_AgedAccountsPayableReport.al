report 50000 "Bizongo Aged Accounts Payable"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/Bizongo_AgedAccountsPayableReport.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Bizongo Aged Accounts Payable';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(ExternalDocumentNoCaptionLbl; ExternalDocumentNoCaptionLbl)
            {
            }
            ...
            dataitem(CurrencyLoop; "Integer")
            {
                ...
                dataitem(TempVendortLedgEntryLoop; "Integer")
                {
                    ...
                    column(VendorLedgEntryEndingDateDocumentDate; Format(VendorLedgEntryEndingDate."Document Date"))
                    {
                    }
                    ...
                    begin
                        ...
                        ExternalDocumentNo := VendorLedgEntryEndingDate."External Document No.";
