// report 50030 "Purchase-Invoice GST"
// {
//     DefaultLayout = RDLC;
//     RDLCLayout = './Reports SPRNG/Rep_50030_PurchaseInvoice.rdl';
...
//                     REPEAT
//                         CommentText += PurchCommentLine.Comment;
//                     UNTIL PurchCommentLine.NEXT = 0;

//                 CommentText := 'Remarks : ' + CommentText;
...
//                 "Your Reference" := "Vendor Invoice No."; //ALLE SKD SEPL

//                 IF "Your Reference" = '' THEN
//                     ReferenceText := ''
//                 ELSE
//                     //ReferenceText := FIELDCAPTION("Your Reference");
//                     ReferenceText := FIELDCAPTION("Vendor Invoice No."); //ALLE SKD SEPL
//             end;
