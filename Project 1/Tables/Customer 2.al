...
//         CustomReportSelection.SetRange("Source Type", DATABASE::"Customer 2");
...
//         DimMgt.DeleteDefaultDim(DATABASE::"Customer 2", "No.");
...
//         DimMgt.RenameDefaultDim(DATABASE::"Customer 2", xRec."No.", "No.");
...
//         customer2: Record "Customer 2";

//     procedure AssistEdit(OldCust: Record "Customer 2"): Boolean
//     var
//         Cust: Record "Customer 2";
//     begin
//         with Cust do begin
//             Cust := Rec;
//             SalesSetup.Get();
...
//             DimMgt.SaveDefaultDim(DATABASE::"Customer 2", "No.", FieldNumber, ShortcutDimCode);
//             Modify();
//         end;
...
//         Cont: Record Contact;
//         TempCust: Record "Customer 2" temporary;
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
...
//     procedure CheckBlockedCustOnDocs(Cust2: Record "Customer 2"; DocType: Enum "Sales Document Type"; Shipment: Boolean; Transaction: Boolean)
//     var
...
//     procedure CheckBlockedCustOnJnls(Cust2: Record "Customer 2"; DocType: Enum "Gen. Journal Document Type"; Transaction: Boolean)
//     var
//         Source: Option Journal,Document;
//     begin
...
//     procedure CheckBlockedCustOnJnls(Cust2: Record "Customer 2"; var GenJnlLine: Record "Gen. Journal Line"; Transaction: Boolean)
//     var
//         IsHandled: Boolean;
//     begin
//         IsHandled := false;
...
//     procedure CustBlockedErrorMessage(Cust2: Record "Customer 2"; Transaction: Boolean)
//     var
//         "Action": Text[30];
//         IsHandled: Boolean;
//     begin
...
//     procedure CustPrivacyBlockedErrorMessage(Cust2: Record "Customer 2"; Transaction: Boolean)
//     var
//         "Action": Text[30];
//     begin
//         if Transaction then
...
//     procedure GetPrivacyBlockedGenericErrorText(Cust2: Record "Customer 2"): Text[250]
//     begin
...
//     begin
//         OnlineMapManagement.MakeSelectionIfMapEnabled(Database::"Customer 2", GetPosition());
//     end;
...
//     var
//         CustomerSalesYTD: Record "Customer 2";
//         AccountingPeriod: Record "Accounting Period";
//         StartDate: Date;
//         EndDate: Date;
//         IsHandled: Boolean;
...
//     procedure HasDifferentAddress(OtherCustomer: Record "Customer 2") Result: Boolean
//     begin
...
//     local procedure MarkCustomersWithSimilarName(var Customer: Record "Customer 2"; CustomerText: Text)
//     var
...
//     local procedure PickCustomer(var Customer: Record "Customer 2"; NoFiltersApplied: Boolean): Code[20]
//     var
...
//     procedure SelectCustomer(var Customer: Record "Customer 2"): Boolean
//     begin
//         exit(LookupCustomer(Customer));
//     end;

//     [Scope('OnPrem')]
//     procedure LookupCustomer(var Customer: Record "Customer 2"): Boolean
//     var
...
//     local procedure MarkCustomersByFilters(var Customer: Record "Customer 2")
//     begin
//         if Customer.FindSet() then
//             repeat
//                 Customer.Mark(true);
...
//         if not VATRegistrationNoFormat.Test("VAT Registration No.", "Country/Region Code", "No.", DATABASE::"Customer 2") then
//             exit;
...
//     procedure FindByEmail(var Customer: Record "Customer 2"; Email: Text): Boolean
//     var
...
//     begin
//         DataTypeManagement.InsertFieldToBuffer(TempField, DATABASE::"Customer 2", FieldNo("Currency Id"));
//         DataTypeManagement.InsertFieldToBuffer(TempField, DATABASE::"Customer 2", FieldNo("Payment Terms Id"));
//         DataTypeManagement.InsertFieldToBuffer(TempField, DATABASE::"Customer 2", FieldNo("Payment Method Id"));
//         DataTypeManagement.InsertFieldToBuffer(TempField, DATABASE::"Customer 2", FieldNo("Shipment Method Id"));
//         DataTypeManagement.InsertFieldToBuffer(TempField, DATABASE::"Customer 2", FieldNo("Tax Area ID"));
//     end;
...
//     local procedure OnBeforeIsContactUpdateNeeded(Customer: Record "Customer 2"; xCustomer: Record "Customer 2"; var UpdateNeeded: Boolean; ForceUpdateContact: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterCopyFromNewCustomerTemplate(var Customer: Record "Customer 2"; CustomerTemplate: Record "Customer Templ.")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnAfterHasAnyOpenOrPostedDocuments(var Customer: Record "Customer 2"; var HasAnyDocs: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterHasAddressIgnoreCountryCode(Customer: Record "Customer 2"; var Result: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterHasDifferentAddress(Customer: Record "Customer 2"; OtherCustomer: Record "Customer 2"; var Result: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterLookupCity(var Customer: Record "Customer 2"; var PostCodeRec: Record "Post Code")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterLookupPostCode(var Customer: Record "Customer 2"; xCustomer: Record "Customer 2"; var PostCodeRec: Record "Post Code")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterOnInsert(var Customer: Record "Customer 2"; xCustomer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterSetLastModifiedDateTime(var Customer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterValidateCity(var Customer: Record "Customer 2"; xCustomer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterValidatePostCode(var Customer: Record "Customer 2"; xCustomer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAfterValidateShortcutDimCode(var Customer: Record "Customer 2"; var xCustomer: Record "Customer 2"; FieldNumber: Integer; var ShortcutDimCode: Code[20])
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnAssistEditOnBeforeExit(var Customer: Record "Customer 2")
//     begin
//     end;

//     local procedure IsOnBeforeCheckBlockedCustHandled(Customer: Record "Customer 2"; Source: Option Journal,Document; DocType: Enum "Gen. Journal Document Type"; Shipment: Boolean; Transaction: Boolean) IsHandled: Boolean
//     begin
//         OnBeforeCheckBlockedCust(Customer, Source, DocType.AsInteger(), Shipment, Transaction, IsHandled)
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCheckBlockedCust(Customer: Record "Customer 2"; Source: Option Journal,Document; DocType: Option; Shipment: Boolean; Transaction: Boolean; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCheckBlockedCustOnJnls(Customer: Record "Customer 2"; var GenJnlLine: Record "Gen. Journal Line"; Transaction: Boolean; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCheckIfOrderSalesLinesExist(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCalcOverdueBalance(var Customer: Record "Customer 2"; var OverdueBalance: Decimal; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeGetInvoicedPrepmtAmountLCY(var Customer: Record "Customer 2"; var InvoicedPrepmtAmountLCY: Decimal; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeGetTotalAmountLCY(var Customer: Record "Customer 2"; var TotalAmountLCY: Decimal; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeGetTotalAmountLCYUI(var Customer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeGetTotalAmountLCYCommon(var Customer: Record "Customer 2"; var AdditionalAmountLCY: Decimal; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeGetSalesLCY(var Customer: Record "Customer 2"; var CustomerSalesYTD: Record "Customer 2"; var SalesLCY: Decimal; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeInsert(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeLookupCity(var Customer: Record "Customer 2"; var PostCodeRec: Record "Post Code")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeLookupContactList(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeLookupPostCode(var Customer: Record "Customer 2"; var PostCodeRec: Record "Post Code")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeOpenCustomerLedgerEntries(var Customer: Record "Customer 2"; var DetailedCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; FilterOnDueEntries: Boolean; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeOnDelete(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeOnRename(var Customer: Record "Customer 2"; xCustomer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeSetDefaultSalesperson(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeTestNoSeries(var Customer: Record "Customer 2"; xCustomer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeUpdateDirectDebitPmtTermsCode(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeValidateCity(var Customer: Record "Customer 2"; var PostCodeRec: Record "Post Code"; CurrentFieldNo: Integer; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeValidateVATRegistrationNo(var Customer: Record "Customer 2"; xCustomer: Record "Customer 2"; FieldNumber: Integer; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeValidatePostCode(var Customer: Record "Customer 2"; var PostCodeRec: Record "Post Code"; CurrentFieldNo: Integer; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeValidateShortcutDimCode(var Customer: Record "Customer 2"; var xCustomer: Record "Customer 2"; FieldNumber: Integer; var ShortcutDimCode: Code[20]; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeVATRegistrationValidation(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnGetCustNoOpenCardOnBeforeCustomerFindSet(var Customer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnGetCustNoOpenCardOnBeforeFilterCustomer(var Customer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnGetCustNoOpenCardOnAfterSetCustomerFilters(var Customer: Record "Customer 2"; var CustomerFilterContains: Text);
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnMarkCustomersWithSimilarNameOnBeforeCustomerFindSet(var Customer: Record "Customer 2")
//     begin
//     end;
...
//     local procedure OnBeforeValidateContact(var IsHandled: Boolean; var Customer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeValidateEmail(var Customer: Record "Customer 2"; var IsHandled: Boolean; xCustomer: Record "Customer 2")
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnGetCustNoOpenCardOnAfterOnAfterCustomerFilterFromStart(var Customer: Record "Customer 2")
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCustBlockedErrorMessage(Cust2: Record "Customer 2"; Transaction: Boolean; var IsHandled: Boolean)
//     begin
//     end;

//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeCalcAvailableCreditCommon(var Rec: Record "Customer 2"; CalledFromUI: Boolean; var CreditLimitLCY: Decimal)
//     begin
//     end;
...
//     [IntegrationEvent(false, false)]
//     local procedure OnBeforeValidateRegistrationNumber(var Customer: Record "Customer 2"; var IsHandled: Boolean)
//     begin
//     end;
